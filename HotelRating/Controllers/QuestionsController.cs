...
namespace HotelRating.Controllers
{
    public class QuestionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Text,Type,HotelId")] Question question)
        {
            ...
            ViewData["HotelId"] = new SelectList(_context.Hotels, "Id", "Id", question.HotelId);
            return View(question);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Text,Type,HotelId")] Question question)
        {
            if (id != question.Id)
            {
                return NotFound();
